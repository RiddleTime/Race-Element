...
internal class HondaNsxGT3Evo : ICarSetupConversion
{
    ...
    private class TyreSetup : AbstractTyresSetup
    {
        ...
        private readonly double[] casters = [7.2, 7.4, 7.6, 7.8, 8.0, 8.2, 8.4, 8.6, 8.8, 8.9, 9.1];
    ...
    private class MechSetup : IMechanicalSetup
    {
        ...
        private readonly int[] fronts = [ 73000, 79080, 85160, 91240,
            97320, 103400, 109480, 115560, 121640, 127720, 133800, 139880, 145960,
            152040, 158120, 164200, 170280 ];
        private readonly int[] rears = [ 126800, 134700, 142600, 150500,
