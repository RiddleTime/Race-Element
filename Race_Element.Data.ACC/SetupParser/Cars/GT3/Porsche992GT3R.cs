...
namespace RaceElement.Data.Cars.GT3
{
    internal class Porsche992GT3R : ICarSetupConversion, ISetupChanger
    {
        ...
        private static readonly double[] casters = new double[] {6.5, 6.7, 6.9, 7.1, 7.3, 7.5, 7.7, 7.8, 8.0, 8.2, 8.4, 8.6, 8.8, 9.0, 9.2, 9.4, 9.6, 
        ...
        private class AeroSetupChanger : IAeroSetupChanger
        {
            ...
            public SetupIntRange Splitter => new SetupIntRange(0, 0, 0);
