...
namespace ACCManager.Data.ACC.Tracks.Data
{
    internal class MountPanorama : AbstractTrackData
    {
        ...
        public override Dictionary<FloatRangeStruct, (int, string)> CornerNames => new Dictionary<FloatRangeStruct, (int, string)>()
        {
            ...
            { new FloatRangeStruct(0.563171f, 0.5718289f), (14, "The Esses")},
            { new FloatRangeStruct(0.5725902f, 0.5816819f), (15, "The Esses")},
            { new FloatRangeStruct(0.5878358f, 0.6015362f), (16, "The Esses")},
            { new FloatRangeStruct(0.6016375f, 0.6116911f), (17, "The Esses")},
            { new FloatRangeStruct(0.6119199f, 0.6392431f), (18, "The Dipper")},
            { new FloatRangeStruct(0.6476261f, 0.6779644f), (19, "Forrest's Elbow")},
