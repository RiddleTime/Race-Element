...
internal sealed class LagunaSeca : AbstractTrackData
{
    ...
    public override List<float> Sectors => [0.25f, 0.63f];
    ...
    public override Dictionary<FloatRangeStruct, (int, string)> CornerNames => new()
    {
        ...
        { new FloatRangeStruct(0.6687181f, 0.6897181f), (8, "Zanardi Corkscrew")},
        { new FloatRangeStruct(0.6899807f, 0.7132857f), (9, "Zanardi Corkscrew")},
