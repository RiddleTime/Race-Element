...
<p>The first 200 Hz HUD in Race Element is the newly added Shift Bar HUD. It will allow you to spot the right moment instead of losing laptime whilst waiting for a 30-60 hz shift bar to blink.
...
<h1 id="what-is-next-1">What is next?</h1>
...
The new Shift Bar HUD serves as an example that Race Element&#39;s renderer is not only quick but that it&#39;s capable of doing so with minimal cpu usage. </p>
`;export{e as default};
