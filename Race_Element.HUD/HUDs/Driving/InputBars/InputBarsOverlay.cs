...
namespace RaceElement.HUD.HUDs.Driving.OverlayInputBars;
...
internal sealed class InputBarsOverlay : AbstractOverlay
{
    ...
    // TODO: connect to sim data provider
    private LocalCarData _localCar;
    ...
    public override void Render(Graphics g)
    {
        ...
        if (_config.Bars.Orientation == InputBarsConfiguration.BarOrientation.Horizontal)
        {
            ...
            _horizontalGasBar.Value = _localCar.Inputs.Throttle;
            _horizontalBrakeBar.Value = _localCar.Inputs.Brake;
        ...
        else
        {
            ...
            _verticalBrakeBar.Value = _localCar.Inputs.Brake;
            _verticalGasBar.Value = _localCar.Inputs.Throttle;
    ...
    {
        float tcActivation = _localCar.Electronics.TractionControlActivation;
        float absActivation = _localCar.Electronics.AbsActivation;
