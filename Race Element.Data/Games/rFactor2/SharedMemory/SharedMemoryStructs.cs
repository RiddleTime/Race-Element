...
namespace RaceElement.Data.Games.rFactor2.SharedMemory
{
    sealed class SharedMemoryStructs
    {
        ...
        public struct RF2Telemetry
        {
            ...
            public int mNumVehicles;                  // current number of vehicles
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = Constants.MAX_MAPPED_VEHICLES)]
        ...
        public struct RF2Extended
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = Constants.MAX_MAPPED_IDS)]
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = Constants.MAX_STATUS_MSG_LEN)]
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = Constants.MAX_RULES_INSTRUCTION_MSG_LEN)]
        ...
        public struct RF2HWControl
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = Constants.MAX_HWCONTROL_NAME_LEN)]
