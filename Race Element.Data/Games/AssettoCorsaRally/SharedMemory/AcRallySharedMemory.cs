...
namespace RaceElement.Data.Games.AssettoCorsaRally.SharedMemory;

/// <summary>
/// Used certain shared memory from https://github.com/gro-ove/actools
/// </summary>
public sealed unsafe class AcRallySharedMemory
{
    ...
    private static AcRallySharedMemory _instance;
    public static AcRallySharedMemory Instance
    {
        get
        {
            _instance ??= new AcRallySharedMemory();

            return _instance;
        }
    }

    private AcRallySharedMemory()
    {
        ReadStaticPageFile();
        ReadPhysicsPageFile();
