...
public sealed class IRacingDataProvider : AbstractSimDataProvider
{
    ...
    private IRacingSdkDatum EnergyERSBatteryPctDatum;
    ...
    private void InitDatums()
    {
        ...
        EnergyERSBatteryPctDatum = _iRacingSDK.Data.TelemetryDataProperties["EnergyERSBatteryPct"];
    ...
    private void OnTelemetryData()
    {
        ...
        try
        {
            ...
            localCar.Electronics.HybridEnergy = _iRacingSDK.Data.GetFloat(EnergyERSBatteryPctDatum) * 100f; // 0-1 to 0-100%
