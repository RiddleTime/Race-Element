...
The first 200 Hz HUD in Race Element is the newly added Shift Bar HUD. It will allow you to spot the right moment instead of losing laptime whilst waiting for a 30-60 hz shift bar to blink.
...
The new Shift Bar HUD serves as an example that Race Element's renderer is not only quick but that it's capable of doing so with minimal cpu usage. 
