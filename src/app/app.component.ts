  ...
  template: `
    <div class="container mx-auto flex flex-col self-center">
      ...
      <nav class="text-lg font-['Conthrax'] mx-auto md:text-2xl flex flex-wrap">
        ...
        <a href="/guide/how-to-get-started" class="mx-auto text-[white] hover:text-[red] hover:bg-[rgba(0,0,0,0.8)] ml-1 mr-1 pl-2 pr-2 bg-[rgba(0.2,0.2,0.2)] rounded-tl-lg rounded-br-lg">Download</a>
       </nav>
